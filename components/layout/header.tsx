...
export default function Header(props: HeaderProps) {
  ...
  return (
    <div className={showMenu 
      ? "dark:bg-zinc-900 blur saturate-50 body-width bg-white flex flex-row justify-between h-24 items-center " 
      : " z-40 dark:bg-zinc-900 body-width bg-white flex flex-row justify-between h-48 items-start "} data-testid="header-div">
{/*       <div className="self-end rounded-full overflow-hidden flex items-center  p-1 shadow ml-8">
